...
Route::group(['prefix' => 'api'], function ($router) {
    ...
    Route::group(['namespace' => 'Webkul\API\Http\Controllers\Shop', 'middleware' => ['locale', 'theme', 'currency']], function ($router) {
        ...
        Route::get('about-us', 'CoreController@Pages')->name('about-us');
        Route::get('return-policy', 'CoreController@Pages')->name('return-policy');
        Route::get('refund-policy', 'CoreController@Pages')->name('refund-policy');
        Route::get('terms-conditions', 'CoreController@Pages')->name('terms-conditions');
        Route::get('terms-of-use', 'CoreController@Pages')->name('terms-of-use');
        Route::get('contact-us', 'CoreController@Pages')->name('contact-us');

        Route::get('home-categories', 'CategoryController@products');
        ...
        Route::get('categories-products', 'CategoryController@products');
        ...
        Route::get('reviews', 'ResourceController@index')->defaults('_config', [
            ...
            'resource' => 'Webkul\API\Http\Resources\Catalog\ProductReviewM'
        ]);
        ...
        Route::get('orders', 'ResourceController@index')->defaults('_config', [
            ...
            'resource' => 'Webkul\API\Http\Resources\Sales\OrderM',
            'authorization_required' => true
        ]);
        ...
        Route::get('wishlist', 'ResourceController@index')->defaults('_config', [
            ...
            'resource' => 'Webkul\API\Http\Resources\Customer\WishlistM',
            'authorization_required' => true
        ]);
