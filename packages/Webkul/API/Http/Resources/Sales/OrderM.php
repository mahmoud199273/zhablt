...
class OrderM extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'shipping_address'                   => new OrderAddressM($this->shipping_address),
            'billing_address'                    => new OrderAddressM($this->billing_address),
            'updated_at'                         => $this->updated_at,
            'items'                              => OrderItemM::collection($this->items),
